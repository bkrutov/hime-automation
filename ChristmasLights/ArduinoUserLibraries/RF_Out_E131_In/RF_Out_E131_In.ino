...
#define UNIVERSE                        20 //Lena's lighthouse Doors
#define UNIVERSE_2                      21 //Lena's lighthouse Ceiling

// IP Address Description: http://learn.komby.com/wiki/58/configuration-settings#IP-Address
static uint8_t ip[] = { 192, 168, 1, 201 };
...
#define TRANSMIT_CHANNEL_2              21 //Lena's lighthouse Ceiling
